$(document).on('ready', function() {
	// Links to Firebase
	var database = new Firebase("https://rps-multiplayer-bootcamp.firebaseio.com/");
	var presenceRef = new Firebase('https://rps-multiplayer-bootcamp.firebaseio.com/.info/connected');
	var playersRef = new Firebase('https://rps-multiplayer-bootcamp.firebaseio.com/playersRef');
	var turnRef = new Firebase('https://rps-multiplayer-bootcamp.firebaseio.com/turn');
	var chatRef = new Firebase('https://rps-multiplayer-bootcamp.firebaseio.com/chat');
